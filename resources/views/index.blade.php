  ...
  <div class="sliderWrap">
    ...
    <div class="sliderViewport">
      <div class="sliderTrack" id="track">
        ...
        <div class="cardPro productCard" data-name="{{ $p1['name'] }}" data-price="{{ $p1['price'] }}" data-img="{{ $p1['img'] }}">
          <div class="cardMedia">
        ...
        <div class="cardPro productCard" data-name="{{ $p2['name'] }}" data-price="{{ $p2['price'] }}" data-img="{{ $p2['img'] }}">
          <div class="cardMedia">
        ...
        <div class="cardPro productCard" data-name="{{ $p3['name'] }}" data-price="{{ $p3['price'] }}" data-img="{{ $p3['img'] }}">
          <div class="cardMedia">
        ...
        <div class="cardPro productCard" data-name="{{ $p4['name'] }}" data-price="{{ $p4['price'] }}" data-img="{{ $p4['img'] }}">
          <div class="cardMedia">
...
<section class="splitHero">
  <a class="heroCard" href="{{ route('shop', ['cat'=>'outerwear']) }}">
  ...
  <a class="heroCard" href="{{ route('shop', ['cat'=>'cable']) }}">
...
<section class="luxTiles">
  ...
  <div class="luxGrid">
    <a class="luxTile" href="{{ route('shop', ['cat'=>'women']) }}">
    ...
    <a class="luxTile" href="{{ route('shop', ['cat'=>'men']) }}">
    ...
    <a class="luxTile" href="{{ route('shop', ['cat'=>'home']) }}">
    ...
    <a class="luxTile" href="{{ route('shop', ['cat'=>'office']) }}">
      <img class="luxImg" src="{{ asset('assets/img/Elegant leather office essentials display.png') }}" alt="Luxury Collection">
      <div class="luxShade"></div>
      <div class="luxText">
        <div class="luxKicker">Legacy Leather Goods</div>
...
<script>
  ...
  function initSearch(){
    ...
    const products = cards.map((card, idx) => {
      ...
      return { id: idx+1, name, price, img, href, cat: "Leather" };
    });
  ...
  function initHeroImageSwiper(){
    ...
    banner.addEventListener("touchstart",(e)=>{ dragging=true; startX=e.touches[0].clientX; },{passive:true});
  ...
  function initDrawerUI(){
    ...
    function hide(){ overlay.classList.remove("show"); drawer.classList.remove("show"); }
  ...
  async function refreshCartCount(){
    try{
      const res = await fetch("{{ route('cart.count') }}", { headers: { "Accept":"application/json" }});
